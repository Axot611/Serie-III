...
HD_PWD='C:/Users/Abner Xot/FSM_ELEVATOR/FSM_ELEVATOR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_module_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_module_tb.tcl
